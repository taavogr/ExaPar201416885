...
<body>
  ...
  <div class="section no-pad-bot">
      <div class="container">
        <br><br>
        <h1 class="header center teal-text text-lighten-2">PARCIAL DE CLOUD</h1>
 ...
 ?> 
  ...
  <footer class="page-footer teal">
    ...
    <div class="footer-copyright">
      <div class="container">
      Made by <a class="brown-text text-lighten-3" href="https://www.linkedin.com/in/gustavo-retamozo-falcon-411583112/">Tavo</a>
      </div>
    </div>
  </footer>
